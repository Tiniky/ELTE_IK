...
--Definiálj egy `filterEven` függvényt, amely egy tetszőleges paraméterül kapott egészeket tartalmazó listából kiszűri a páros számokat! A megoldáshoz használj rekurziót!
filterEven :: [Int] -> [Int]
filterEven [] = []
filterEven (x:xs)
