...
type AssignmentResult = (Student, Int)
...
data SignedInt = Minus Int | Zero | Plus Int deriving (Show, Eq)
...
interval (x,y) = map toSigned [fromSigned x .. fromSigned y]
